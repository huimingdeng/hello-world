...
<html>
<head>
	<title>wrap方法和unwrap()方法</title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="css/public.css">
	<script type="text/javascript" src="js/jquery.js"></script>
	<style type="text/css">.aaron1,.aaron2{clear:both;}</style>
</head>
<body>
	<div class="container w980">
		...
		<footer>&copy;by imooc&dhm &nbsp; &nbsp; 2017.11.10 &nbsp; <a href="/"><?php echo $_SERVER['HTTP_HOST'];?></a></footer>
