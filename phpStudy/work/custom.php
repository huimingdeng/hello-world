  ...
  // Other volume input radio
   ...
   function trim(str){
	...
	function checkForm(){
	    ...
	    if(!jQuery("input[name='mauticform[6_indicate_the_reporter_g]']").is(':checked')&&jQuery("input[name='mauticform[6_indicate_the_reporter_g]']").length>0){
	...
	jQuery(document).ready(function($){ 
        ...
        var noarr=new Array();
		jQuery(".NoChange").each(function(index){
			noarr[index]=jQuery(this).text();
		});
        jQuery("#sgRNAcheckBoxes .mauticform-radiogrp-radio").bind("click",function(){
    		...
    		if(jQuery(this).is(":checked")){
	    		...
	    		if(!count){
	    			...
	    			if(count==1){
	    				jQuery(".NoChange").each(function(index){
		    				jQuery(this).text(noarr[index]-1);
		    			});
	    			}
		...
		<div class="mauticform-innerform">
			...
			<div class="mauticform-row mauticform-radiogrp mauticform-required" data-validate="2_what_is_the_adenoassoci" data-validation-type="radiogrp" id="mauticform_customadenoassociatedvirusproductionservices_2_what_is_the_adenoassoci"><span style="font-weight:bold;">2. What is the adeno-associated virus for? </span><span style="color:red;"> *</span>
				...
				<div class="mauticform-radiogrp-row" id="sgRNAcheckBoxes" style="padding:2px 0;">
					<input class="mauticform-radiogrp-radio" id="mauticform_radiogrp_radio_2_what_is_the_adenoassoci_HumansgRNA" name="mauticform[2_what_is_the_adenoassoci][]" type="checkbox" value="Human sgRNA" /><span style="padding:0 30px 0 4px;"> Human sgRNA&nbsp; </span><input class="mauticform-radiogrp-radio" id="mauticform_radiogrp_radio_2_what_is_the_adenoassoci_MousesgRNA" name="mauticform[2_what_is_the_adenoassoci][]" type="checkbox" value="Mouse sgRNA" /><span style="padding:0 30px 0 4px;"> Mouse sgRNA </span><input class="mauticform-radiogrp-radio" id="mauticform_radiogrp_radio_2_what_is_the_adenoassoci_RatsgRNA" name="mauticform[2_what_is_the_adenoassoci][]" type="checkbox" value="Rat sgRNA" /><span style="padding:0 30px 0 4px;"> Rat sgRNA </span>
				</div>
			...
			<div class="mauticform-row mauticform-radiogrp mauticform-required" data-validate="7_indicate_the_total_amou" data-validation-type="radiogrp" id="mauticform_customadenoassociatedvirusproductionservices_7_indicate_the_total_amou"><span style="font-weight:bold;"><span class="NoChange">8</span>. Indicate the total volume you need </span><span style="color:red"> *</span>
