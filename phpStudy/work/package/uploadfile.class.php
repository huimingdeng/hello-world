<?php 
	...
	*/
	class uploadfile
	{
		 ...
		 */
		public function __construct( $fileName='file', $uploadPath="./uploads", $allowedExt=array('jpeg','jpg','png','gif','txt','csv'), $maxSize=5242880, $allowedMime=array('image/jpeg','image/png','image/gif','text/plain','application/vnd.ms-excel'), $imgflag=false )
		{
