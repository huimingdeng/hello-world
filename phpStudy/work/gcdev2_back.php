...
<p><script src="http://code.jquery.com/ui/1.12.1/jquery-ui.js"></script><br />
...
<p>Custom adeno-associated virus particle production is offered for human and mouse ORFs. GeneCopoeia also offers <a href="http://gcdev.fulengen.cn/product/aavprime-adeno-associated-virus-particles/">pre-made AAV particles </a> carrying various genes and promoters.</p>
	...
	<form action="http://othello.genecopoeia.com/mautic/index.php/form/submit?formId=8" autocomplete="false" data-mautic-form="customadenoassociatedvirusproductionservices" id="mauticform_customadenoassociatedvirusproductionservices" method="post" role="form">
		<div class="mauticform-innerform">
			<table>
				<tbody>
					...
					<tr>
						...
						<td style="height:30px;vertical-align:middle;">
							<div class="mauticform-row mauticform-email mauticform-required" data-validate="email" data-validation-type="email" id="mauticform_customadenoassociatedvirusproductionservices_email" style="display: inline;"><input class="mauticform-input" id="mauticform_input_customadenoassociatedvirusproductionservices_email" name="mauticform[email]" style="width: 160px;" type="email" value="" /><span style="color:red;"> * </span> <span class="mauticform-errormsg" style="display: none;"><img alt="This Field Empty" border="0" src="../images/stop.jpg" /> (This Field Request ! ) </span></div></td></tr>
					<tr>
						<td>&nbsp;</td>
						<td style="vertical-align:middle;"><input class="mauticform-checkboxgrp-checkbox" id="mauticform_checkboxgrp_checkbox_please_check_if_you_do_no_PleasecheckifyouDoNotwishtoreceivepromotionandnewproductinformation" name="mauticform[please_check_if_you_do_no][]" type="checkbox" value="No" />Please check if you DO NOT wish to receive promotional and new product information</td></tr>
					<tr>
						<td style="width:100px;height:30px;vertical-align:middle;">Telephone:</td>
						<td style="height:30px;vertical-align:middle;">
							<div class="mauticform-row mauticform-tel mauticform-required" data-validate="telephone" data-validation-type="tel" id="mauticform_customadenoassociatedvirusproductionservices_telephone" style="display: inline;"><input class="mauticform-input" id="mauticform_input_customadenoassociatedvirusproductionservices_telephone" name="mauticform[telephone]" style="width: 160px;" type="tel" value="" /><span style="color:red;"> * </span><span class="mauticform-errormsg" style="display: none;"><img alt="This Field Empty" border="0" src="../images/stop.jpg" /> (This Field Request ! ) </span></div></td></tr></tbody></table>
			<p>&nbsp;</p>
			<div class="mauticform-row mauticform-radiogrp mauticform-required" data-validate="2_what_is_the_adenoassoci" data-validation-type="radiogrp" id="mauticform_customadenoassociatedvirusproductionservices_2_what_is_the_adenoassoci"><span style="font-weight:bold;">2. What is the adeno-associated virus for? </span><span style="color:red;"> *</span>
				<p>&nbsp;</p>
				<div class="mauticform-radiogrp-row" style="padding:2px 0;"><input class="mauticform-radiogrp-radio" id="mauticform_radiogrp_radio_2_what_is_the_adenoassoci_HumanORF" name="mauticform[2_what_is_the_adenoassoci][]" type="checkbox" value="Human ORF" /><span style="padding:0 30px 0 4px;"> Human ORF&nbsp; </span><input class="mauticform-radiogrp-radio" id="mauticform_radiogrp_radio_2_what_is_the_adenoassoci_HumanORF" name="mauticform[2_what_is_the_adenoassoci][]" type="checkbox" value="Mouse ORF" /><span style="padding:0 30px 0 4px;"> Mouse ORF </span></div>
				<p>&nbsp;</p>
				<p>&nbsp;</p></div>
			<div class="mauticform-row mauticform-text mauticform-required" data-validate="3_enter_the_identificatio" data-validation-type="text" id="mauticform_customadenoassociatedvirusproductionservices_3_enter_the_identificatio"><span style="font-weight:bold;">3. Enter your gene information,</span> i.e. accession number (preferred), gene ID or gene symbol<br />
			...
			<div class="mauticform-row mauticform-radiogrp mauticform-required" data-validate="6_do_you_plan_to_use_aav" data-validation-type="radiogrp" id="mauticform_customadenoassociatedvirusproductionservices_6_do_you_plan_to_use_aav"><span style="font-weight:bold">7. Do you plan to use AAV particles for animals (<i>in vivo</i>)? </span><span style="color:red;"> *</span>
				...
				<p>&nbsp;</p>
				<p>&nbsp;</p></div>
			<div class="mauticform-row mauticform-radiogrp mauticform-required" data-validate="7_indicate_the_total_amou" data-validation-type="radiogrp" id="mauticform_customadenoassociatedvirusproductionservices_7_indicate_the_total_amou"><span style="font-weight:bold;">8. Indicate the total volume you need </span><span style="color:red"> *</span>
				<p>&nbsp;</p>
...
<div id="dialog-modal" style="display:none;" title="Note">
	<p style="font-weight:bold;">Your browser version is too low. Please upgrade or use the Chrome browser to ensure that the form is submitted properly.</p></div>